...
class AssignmentsScreen extends StatefulWidget {
  ...
  AssignmentsScreen({required this.studentId});
...
class _AssignmentsScreenState extends State<AssignmentsScreen> {
  ...
  Future<void> _loadAssignments() async {
    ...
    try {
      ...
      print('📚 Loading assignments for user ID: ${widget.studentId}');
      final response = await ApiService.getStudentAssignments(widget.studentId);
      ...
      if (response['success'] == true && response['data'] != null) {
        ...
        setState(() {
          _error = response['message'] ?? 'Failed to load assignments';
          _isLoading = false;
        });
      }
    } catch (e) {
...
Widget build(BuildContext context) {
  ...
  Widget _buildAssignmentCard(Map<String, dynamic> assignment) {
    ...
    final description = assignment['description'] ?? 'No description available';
    final createdAt = assignment['created_at'] ?? '';
    final hasPDF = assignment['file_path'] != null && 
